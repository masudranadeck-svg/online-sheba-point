...
export default function Navbar() {
  ...
  // আপডেট করা মেন্যু লিস্ট
  const menuItems = [
    {href:'/',l:'হোম'},
    {href:'/shop',l:'শপ'},
    {href:'/marketplace',l:'মার্কেটপ্লেস'},
    {href:'/remote-jobs',l:'Remote Jobs'},
    {href:'/dev-services',l:'ডেভলপমেন্ট'}, // নতুন অপশন
    ...
    <nav style={{
      ...
      <div style={{maxWidth:1280,margin:'0 auto',padding:'0 24px',display:'flex',alignItems:'center',justifyContent:'space-between'}}>
        ...
        <div style={{display:'flex',alignItems:'center',gap:2}} className="hidden lg:flex">
          {menuItems.map(x=>(
            <Link key={x.href} href={x.href} style={{padding:'8px 8px',borderRadius:10,fontSize:12.5,fontWeight:500,color:'#555',textDecoration:'none',transition:'all 0.2s',whiteSpace:'nowrap'}}>{x.l}</Link>
          ))}
        </div>
